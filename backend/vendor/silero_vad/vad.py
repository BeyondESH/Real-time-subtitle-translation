...
# 内嵌说明：本文件复制自 faster-whisper（MIT）vad.py，仅替换资产路径解析来源；
# 语义/参数/时间轴行为与原实现零差异（spec: audio-streaming「音频缓冲与 VAD 语句切分」）。

def get_assets_path():
    """Returns the path to the vendored assets directory."""
